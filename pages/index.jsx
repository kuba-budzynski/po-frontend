        ...
        <div className="max-w-5xl mx-auto py-8 sm:px-6 px-4 lg:px-8">
          <Wrapper>
            ...
            <form onSubmit={onTeamSubmit}>
              <input name="teamIdInput" className="py-3 px-4 bg-gray-100 rounded-lg focus:outline-none focus-visible:ring-2 mr-2 w-1/3" value={teamId} onChange={(e) => setTeamId(e.target.value)} />
